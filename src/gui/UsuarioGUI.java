...
public class UsuarioGUI extends javax.swing.JFrame {
    ...
    Connection connection = null; // faz parte da conexão com o banco para gerar o relatorio completo
    ...
    private void initComponents() {
        ...
        btnListRel = new javax.swing.JButton();
        ...
        btnRelClientes.setText("Rel.Cliente");
        ...
        btnListRel.setText("Lis.Rel");
        btnListRel.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnListRelActionPerformed(evt);
            }
        });
    ...
    // gera o relatorio individual
    private void btnRelClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRelClientesActionPerformed
        
        //pega a linha selecionada pelo usuario na tabela para imprimir
        int row = tbListagemUsuario.getSelectedRow();
        
        //pega o valor que esta na linha para ser empresso
        String arg = tbListagemUsuario.getValueAt(row, 0).toString().trim();
        ...
        try{
            ...
            rel.ficha("C:/Users/BLACK/Documents/NetBeansProjects/crud-java-se-com-mysql-master/src/Report/Relatorio.jasper",arg);
    ...
    // gera o relatorio completo
    private void btnListRelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListRelActionPerformed
       ...
       if(confirma == JOptionPane.YES_OPTION){
           ...
           try {
               ...
               JasperPrint print = JasperFillManager.fillReport("C:/Users/BLACK/Documents/NetBeansProjects/crud-java-se-com-mysql-master/src/Report/ListagemCompleta.jasper",null,connection);
    ...
    }//GEN-LAST:event_btnListRelActionPerformed
    ...
    private javax.swing.JButton btnListRel;
